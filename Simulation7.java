 ...
 * This is the edited version of CloudSimExample6 from CloudSim 5.0
 * I just tried to make it more scalable.
 */
public class Simulation7 {
	...
	private static List<Cloudlet> createCloudlet(int userId, int cloudlets,long length, long fileSize, long outputSize,int pesNumberForCloudlets,UtilizationModel utilizationModel){
		...
		for(int i=0;i<cloudlets;i++){
			cloudlet[i] = new Cloudlet(i, length, pesNumberForCloudlets, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel);
	...
	public static void main(String[] args) {
		Log.printLine("Starting Simulation7...");
		...
		try {
			...
			Datacenter datacenter0 = createDatacenter("Datacenter_0",5,hostId,ram,storage,bw);
			@SuppressWarnings("unused")
			...
			Log.printLine("Simulation7 finished!");
		}
		catch (Exception e)
		{
			e.printStackTrace();
	...
	private static Datacenter createDatacenter(String name,int numHosts,int hostId,int ram,long storage,int bw){
